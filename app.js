            ...
            minorista: {
                ...
                planes: [
                    ...
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, Esta tasa aplica para: Bronco Sport Badlands 2.0L y Big Bend 1.5L, la cuota incluye capital, intereses e IVA",
                    ...
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, Esta tasa aplica solo para: Everest Titanium, la cuota incluye capital, intereses e IVA",
                        utilPara: "Everest",
                    ...
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, Línea exclusiva para Territory Titanium, la cuota incluye capital, intereses e IVA",
                        utilPara: "Solo Territory Titanium",
                        plazos: [{ m: 24, c: 41.67, tna: "0%", cft: "0%", ltv: 25000000, info: "TNA 0%" }] 
                    }, 
                    ...
                    { 
                        ...
                        destacado: true,
                        gastos: 17, seguro: "CAUTIVO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, Aplica para: Territory SEL, Territory Titanium, Territory HEV, la cuota incluye capital, intereses e IVA",
                    ...
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, Aplica para: Ranger XL, 4x2, 4x4 y Chasis (Todas las XL), la cuota incluye capital, intereses e IVA",
                    ...
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para todas las versiones de Ranger excepto Raptor, Seguro liberado, la cuota incluye capital, intereses e IVA",
                        utilPara: "Ranger excepto Raptor",
                    ...
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para todas las versiones de Transit, excepto las E-Transit, para personas fisicas, seguro liberado, la cuota incluye capital, intereses e IVA",
            ...
            comercial: {
                ...
                planes: [
                    ...
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para Ranger XL, seguro liberado, seguro de vida 0,20% sobre saldo",
                        utilPara: "Ranger XL",
                        plazos: [{ m: 12, c: 83.33, tna: "0%", cft: "0%", ltv: 18000000, }] 
                    },
                    ...
                    { 
                        ...
                        destacado: true,
                        ltv: 50, gastos: 2, seguro: "LIBERADO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para Ranger XL y XLS, seguro liberado, sin gastos de otorgamiento, seguro de vida 0,20% sobre saldo",
                    ...
                    { 
                        ...
                        destacado: false, 
                        gastos: 2, seguro: "CAUTIVO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, Financiación para Ranger XL/XLS con seguro cautivo, seguro de vida 0,20% sobre saldo.",
                        utilPara: "Ranger XL y XLS",
                    ...
                    { 
                        ...
                        destacado: true,
                        gastos: 2, seguro: "LIBERADO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, Financiación comercial para Ranger XL y XLS con seguro liberado, seguro de vida 0,20% sobre saldo",
                        utilPara: "Ranger XL y XLS",
                    ...
                    { 
                        ...
                        destacado: false,
                        gastos: 2, seguro: "CAUTIVO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para Transit excepto las E-Transit, seguro de vida 0,20% sobre saldo, seguro cautivo.",
                        utilPara: "Transit excepto E-Transit",
                    ...
                    { 
                        ...
                        destacado: false,
                        gastos: 2, seguro: "LIBERADO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para Transit excepto las E-Transit, seguro liberado, seguro de vida 0,20% sobre saldo",
                        utilPara: "Transit excepto E-Transit",
                    ...
                    { 
                        ...
                        destacado: true,
                        tna: "43,90%", ltv: 75, gastos: 2, seguro: "CAUTIVO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para Kuga, Maverick, F-150, Mustang, Ranger, Territory, Bronco, Transit, seguro de vida 0,20% sobre saldo",
                    ...
                    { 
                        ...
                        destacado: true,
                        tna: "46,90%", ltv: 75, gastos: 2, seguro: "LIBERADO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para Kuga, Maverick, F-150, Mustang, Ranger, Territory, Bronco, Transit",
                        utilPara: "Kuga, Maverick, F-150, Mustang, Ranger, Territory, Bronco, Transit",
                        plazos: [{ m: 12, c: 109.52, cft: "70,15%" }, { m: 24, c: 68.61, cft: "70,13%" }, { m: 36, c: 56.03, cft: "70,12%" }, { m: 48, c: 50.46, cft: "70,11%" }] 
                    },

                    { 
                        nombre: "Generales Canal MiPyme (cautivo)", 
                        destacado: true,
                        tna: "34,00%", ltv: 75, gastos: 2, seguro: "CAUTIVO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para Kuga, Maverick, F-150, Mustang, Ranger, Territory, Bronco, Transit, seguro de vida 0,20% sobre saldo",
                        utilPara: "Kuga, Maverick, F-150, Mustang, Ranger, Territory, Bronco, Transit",
                    ...
                    { 
                        ...
                        destacado: true,
                        tna: "37,00%", ltv: 75, gastos: 2, seguro: "LIBERADO", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para Kuga, Maverick, F-150, Mustang, Ranger, Territory, Bronco, Transit",
                        utilPara: "Kuga, Maverick, F-150, Mustang, Ranger, Territory, Bronco, Transit",
                    ...
                    { 
                        ...
                        destacado: false,
                        gastos: 2, seguro: "Cautivo", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, Línea Mi Pyme exclusiva para unidades Ford Ranger, excepto Raptor",
                        utilPara: "Ranger excepto Raptor",
                    ...
                    { 
                        ...
                        destacado: false,
                        gastos: 2, seguro: "Cautivo", baseCalculo: 1000, 
                        descripcion: "Fecha de vigencia: 02/09/2026, Línea Mi Pyme para unidades Ford Transit, excepto E-Transit.",
                        utilPara: "Transit excepto E-Transit",
                        plazos: [{ m: 24, c: 54.93, tna: "23,90%", cft: "29,37%", ltv: 50, info: "LTV Máx 50%" }, { m: 36, c: 45.72, tna: "30,90%", cft: "38,94%", ltv: 60, info: "LTV Máx 60%" },] 
                    },
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para Transit, excepto E-Transit, para personas fisicas y juridicas, seguro liberado, la cuota incluye capital e intereses",
                        utilPara: "Transit excepto E-Transit",
                    ...
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para todos los modelos de Ranger, la cuota incluye capital, intereses e IVA",
                        utilPara: "Ranger",
                    ...
                    { 
                        ...
                        descripcion: "Fecha de vigencia: 02/09/2026, aplica para todas las versiones de Ranger excepto Raptor, seguro de vida 0,20% sobre saldo.",
                        utilPara: "Ranger excepto Raptor",
                ...
                planes: [
                    ...
                    { 
                        ...
                        plazos: [
                            ...
                            { m: 48, c: 39.54, tna: "30,5%",   g: 14.1, ltv: 40000000 },
                            { m: 60, c: 37.53, tna: "32,5%",   g: 14.1, ltv: 40000000 },
                        ] 
                    },
                    ...
                    { 
                        ...
                        plazos: [
                            ...
                            { m: 18, c: 55.56, tna: "0%",      g: 16.9,  ltv: 15500000 },
                            { m: 24, c: 47.93, tna: "11,50%",  g: 15.91,  ltv: 17000000 }
                        ] 
                    },
                    ...
                    { 
                        ...
                        plazos: [
                            ...
                            { m: 48, c: 34.41, tna: "23,00%",    g: 14.1, ltv: 20000000 },
                            { m: 60, c: 32.73, tna: "26,00%",    g: 14.1, ltv: 20000000 },
                        ] 
                    },                    
                    ...
                    { 
                        ...
                        plazos: [
                            ...
                            { m: 60, c: 32.73, tna: "26,00%",    g: 14.1, ltv: 18500000 },
                        ] 
                    },                
                    ...
                    { 
                        ...
                        plazos: [
                            ...
                            { m: 60, c: 34.54, tna: "28,50%",    g: 14.1, ltv: 24000000 },
                        ] 
                    },
                ]
            },
